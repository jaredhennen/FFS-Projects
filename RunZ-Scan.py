...
class ScanThreeHold:    # Developing the z-scan program with a continuous voltage ramp
...
class ScanplusNHolds(QDialog):    # Developing the z-scan program with a continuous voltage ramp
